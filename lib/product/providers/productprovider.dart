...
class ProductProvider with ChangeNotifier {
  ...
  Future<void> toggleFavorites(String id) async{
    var currentUser=auth.currentUser;
    var obj = await db.collection("UserProductFavorites").doc(currentUser!.uid+id).get();
    if(obj.data()==null){
      await db.collection("UserProductFavorites").doc(currentUser.uid+id).set({
       "isFavorite":true,
    });

    }
    else{
      await db.collection("UserProductFavorites").doc(currentUser.uid+id).update({
